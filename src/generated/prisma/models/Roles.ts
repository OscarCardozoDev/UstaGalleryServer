...
export type RolesWhereInput = {
  ...
  uid?: Prisma.UuidFilter<"Roles"> | string
...
export type RolesScalarWhereWithAggregatesInput = {
  ...
  uid?: Prisma.UuidWithAggregatesFilter<"Roles"> | string
...
export type RolesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"uid" | "name" | "slug" | "createdAt" | "updatedAt", ExtArgs["result"]["roles"]>
...
export interface RolesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `uid`
   * const rolesWithUidOnly = await prisma.roles.findMany({ select: { uid: true } })
   * 
   */
   ...
   * const rolesWithUidOnly = await prisma.roles.createManyAndReturn({
   *   select: { uid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const rolesWithUidOnly = await prisma.roles.updateManyAndReturn({
   *   select: { uid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface RolesFieldRefs {
  readonly uid: Prisma.FieldRef<"Roles", 'String'>
